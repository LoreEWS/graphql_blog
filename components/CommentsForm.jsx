...
const CommentsForm = ({ slug }) => {
  ...
  return (
    <div className="bg-indigo-200 shadow-lg rounded-lg p-8 pb-12 mb-8">
        <h3 className="text-xl mb-8 font-semibold border-b border-blue-400 pb-4">Leave a Reply</h3>
        ...
        <div className="mt-8">
          <button type="button" onClick={handleCommentSubmission} className="transition duration-500 ease hover:bg-sky-900 inline-block bg-purple-700 text-lg rounded-full text-white px-8 py-3 cursor-pointer">
            Post Comment
          </button>
